...
def load_and_process_multimodal_documents(data_path: str = "data") -> List[Dict[str, Any]]:
    """
    Carrega PDFs, extrai texto, tabelas e imagens, e gera descrições multimodais.
    """
                ...
                try:
                    ...
                    try:
                        ...
                        if tables:
                            ...
                            logger.info(f"     Tabelas extraídas: {len(tables)} tabelas")
                        else:
                            logger.info(f"     Nenhuma tabela encontrada na página {page_num}")
                    except Exception as e:
                        logger.warning(f"     Erro ao extrair tabelas na página {page_num}: {e}")
                    ...
                    full_content = (
                        ...
                        f"TEXTO DA PÁGINA:\n{text_content}\n\n"
                        f"TABELAS:\n{table_content if table_content else 'Nenhuma tabela encontrada'}\n\n"
